 ...
 * This is the {@link SQLException} throwing equivalent of {@link BooleanSupplier}.
 */
@FunctionalInterface
public interface BooleanSQLSupplier {
     ...
     */
    static BooleanSupplier unchecked(BooleanSQLSupplier supplier) {
     ...
     * @throws NullPointerException If {@code supplier} is {@code null}.
     */
    static BooleanSQLSupplier checked(BooleanSupplier supplier) {
        Objects.requireNonNull(supplier);
        return () -> {
            try {
                return supplier.getAsBoolean();
