 ...
 * This is the {@link SQLException} throwing equivalent of {@link IntToDoubleFunction}.
 */
@FunctionalInterface
public interface IntToDoubleSQLFunction {
     ...
     */
    double applyAsDouble(int value) throws SQLException;
     ...
     */
    static IntToDoubleFunction unchecked(IntToDoubleSQLFunction function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static IntToDoubleSQLFunction checked(IntToDoubleFunction function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.applyAsDouble(value);
