 ...
 * This is the {@link SQLException} throwing equivalent of {@link LongToIntFunction}.
 */
@FunctionalInterface
public interface LongToIntSQLFunction {
     ...
     */
    int applyAsInt(long value) throws SQLException;
     ...
     */
    static LongToIntFunction unchecked(LongToIntSQLFunction function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static LongToIntSQLFunction checked(LongToIntFunction function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.applyAsInt(value);
