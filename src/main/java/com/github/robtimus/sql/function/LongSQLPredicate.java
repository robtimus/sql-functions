 ...
 * This is the {@link SQLException} throwing equivalent of {@link LongPredicate}.
 */
@FunctionalInterface
public interface LongSQLPredicate {
     ...
     */
    boolean test(long value) throws SQLException;
     ...
     */
    default LongSQLPredicate and(LongSQLPredicate other) {
     ...
     */
    static LongPredicate unchecked(LongSQLPredicate predicate) {
     ...
     */
    static LongSQLPredicate checked(LongPredicate predicate) {
        Objects.requireNonNull(predicate);
        return value -> {
            try {
                return predicate.test(value);
