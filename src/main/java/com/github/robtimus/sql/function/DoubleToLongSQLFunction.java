 ...
 * This is the {@link SQLException} throwing equivalent of {@link DoubleToLongFunction}.
 */
@FunctionalInterface
public interface DoubleToLongSQLFunction {
     ...
     */
    long applyAsLong(double value) throws SQLException;
     ...
     */
    static DoubleToLongFunction unchecked(DoubleToLongSQLFunction function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static DoubleToLongSQLFunction checked(DoubleToLongFunction function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.applyAsLong(value);
